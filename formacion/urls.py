...
urlpatterns = [
    ...
    url(r'^tipo2/(?P<formador_id>\w+)/calificar/(?P<grupo_id>\w+)/(?P<actividad>\w+)/actualizar/(?P<soporte_id>\w+)/$', login_required(views.FormSoporteGrupoView.as_view())),
    url(r'^tipo2/(?P<formador_id>\w+)/calificar/(?P<grupo_id>\w+)/(?P<actividad>\w+)/asignar/(?P<soporte_id>\w+)/$', login_required(views.FormAsignarSoporteView.as_view())),
    url(r'^tipo2/(?P<formador_id>\w+)/calificar/(?P<grupo_id>\w+)/(?P<actividad>\w+)/agregar/$', login_required(views.FormAgregarSoporteView.as_view())),

    url(r'^tipo2/(?P<formador_id>\w+)/calificar/(?P<grupo_id>\w+)/$', login_required(views.FormadorActividadView.as_view())),
